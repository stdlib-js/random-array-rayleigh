...
tape( 'the function throws an error if provided an invalid distribution parameter', function test( t ) {
	var values;
	var i;
...
tape( 'the function throws an error if provided an invalid distribution parameter (options)', function test( t ) {
	var values;
	var i;
...
tape( 'when called without distribution parameters, the function returns a function which generates `NaN` values if a distribution parameter is `NaN`', function test( t ) {
	var random;
	var actual;
	var i;

	random = factory();
	actual = random( 10, NaN );
